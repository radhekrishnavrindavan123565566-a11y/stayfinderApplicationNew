...
const variants = {
  ...
  secondary: "bg-zinc-800 hover:bg-zinc-700 text-white dark:bg-zinc-700 dark:hover:bg-zinc-600",
  outline: "border-2 border-rose-500 text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-950/30",
