...
function getSafetyBadge(score: number): { label: string; className: string } {
  if (score >= 70) return { label: "Very Safe", className: "bg-green-100 text-green-700" };
  if (score >= 50) return { label: "Safe", className: "bg-blue-100 text-blue-700" };
  if (score >= 30) return { label: "Moderate", className: "bg-amber-100 text-amber-700" };
  return { label: "Use Caution", className: "bg-red-100 text-red-700" };
}
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between flex-wrap gap-2">
        <h3 className="text-base font-semibold text-zinc-900">Location Intelligence</h3>
