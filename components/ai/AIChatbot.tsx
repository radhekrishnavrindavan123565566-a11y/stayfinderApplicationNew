...
export default function AIChatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: "assistant", content: "Hi! I'm SST Home Solutions' AI assistant 🏠 I can help you find the perfect property. What are you looking for?" },
  ]);
            ...
            >
              ...
              <div className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-violet-600 to-indigo-600 flex-shrink-0">
                ...
                <div className="flex-1">
                  <p className="text-white font-semibold text-sm">SST Home Solutions AI</p>
