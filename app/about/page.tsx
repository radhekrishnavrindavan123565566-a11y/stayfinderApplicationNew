...
const MILESTONES = [
  { year: "2024", title: "Founded", desc: "SST Home Solutions was born in Prayagraj with a mission to simplify room rentals across UP." },
    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ opacity: heroOpacity }} className="relative z-10 text-center px-4 max-w-4xl mx-auto pt-20">
          ...
          >
            SST Home Solutions connects people with the right rooms and PGs — and helps property owners build thriving rental businesses across Uttar Pradesh.
          </motion.p>
        </motion.div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed mb-6">
                We started SST Home Solutions because we believed finding a great room or PG in UP shouldn&apos;t be stressful or full of surprises. We built a platform where trust is built in — verified listings, transparent pricing, and real reviews from real tenants.
              </p>
      ...
      <section className="py-16 sm:py-20 px-4 max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-zinc-500 dark:text-zinc-400">The people behind SST Home Solutions.</p>
          </motion.div>
      ...
      <section className="py-20 sm:py-24 px-4 bg-gradient-to-br from-rose-500 via-rose-600 to-rose-700 relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-white/80 text-lg mb-8">Join 50,000+ users who trust SST Home Solutions for their housing needs.</p>
