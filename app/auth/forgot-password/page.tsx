              ...
              <>
                ...
                <div className="flex items-center gap-2 mb-6">
                  {(["email", "otp"] as const).map((s, i) => {
                    ...
                    const isComplete = (s === "email" && currentStep !== "email") || (s === "otp" && (currentStep === "password" || currentStep === "done"));
                    return (
                      <div key={s} className="flex items-center gap-2">
                        ...
                        {i < 1 && <div className={`flex-1 h-0.5 w-8 ${currentStep !== "email" ? "bg-green-500" : "bg-zinc-200 dark:bg-zinc-700"}`} />}
                      </div>
                    );
                  })}
                </div>
